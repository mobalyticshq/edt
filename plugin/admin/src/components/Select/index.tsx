...
const Input = React.forwardRef((props: StaticDataSelectProps, ref) => {
    ...
    const getListOfStaticDataOptions = async (filter?: string) => {
        const {get} = getFetchClient();
        let path = `/${pluginId}/types/${staticDataType}/options`
    ...
    return (
        <label>
            <Combobox
                ...
                value={props.value}
                onFilterValueChange={(text: string) => getListOfStaticDataOptions(text)}
            >
